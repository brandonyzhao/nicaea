...
/* ---------------------------------------------------------------- *
 * Stellar mass function (only for leauthaud11 and coupon15 model)               *
 * ---------------------------------------------------------------- */
...
double Ngal_s(cosmo_hm *model, double M, double log10Mstar_min, double log10Mstar_max, error **err);
double Ngal(cosmo_hm *model, double M, double log10Mstar_min, double log10Mstar_max, error **err);
...
double int_for_Mstar_tot_s(double logM10star, void *params, error **err);
